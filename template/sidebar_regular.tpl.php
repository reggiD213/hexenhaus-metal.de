<div class="content33">
	...
	<ul class="box regular layout">
		<div class="summerbreak">
			...
			<img class="summerpic" src="<?php echo BASEPATH; ?>/images/summerbreak.png"">
		</div>
		...
		<li><a target="_blank" href="http://www.cubus-ulm.de"><h3 class="glow">Jeden Donnerstag</h3><img src="<?php echo BASEPATH; ?>/images/tabletop.jpg" alt="Tabletop"></a></li>
	</ul>
</div>